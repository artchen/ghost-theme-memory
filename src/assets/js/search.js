...
(function($) {
  ...
  SearchService = function(options) {
    ...
    self.config = $.extend({
      ...
      brands: {
        'google': {logo: '/assets/img/google.svg', url: 'https://cse.google.com'},
        'algolia': {logo: '/assets/img/algolia.svg', url: 'https://www.algolia.com'},
        'hexo': {logo: '', url: ''},
        'azure': {logo: '/assets/img/azure.svg', url: 'https://azure.microsoft.com/en-us/services/search/'},
        'baidu': {logo: '/assets/img/baidu.svg', url: 'http://zn.baidu.com/cse/home/index'}
      }
    }, options);
